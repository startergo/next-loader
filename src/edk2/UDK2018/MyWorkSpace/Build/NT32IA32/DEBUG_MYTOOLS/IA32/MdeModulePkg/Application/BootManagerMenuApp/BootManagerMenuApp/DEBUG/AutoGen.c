...
#define _PCD_TOKEN_PcdPerformanceLibraryPropertyMask  55U
...
#define _PCD_TOKEN_PcdResetOnMemoryTypeInformationChange  114U
...
#define _PCD_TOKEN_PcdBootManagerMenuFile  118U
...
#define _PCD_TOKEN_PcdDriverHealthConfigureForm  119U
...
#define _PCD_TOKEN_PcdMaxRepairCount  120U
  ...
  )
{
  ...
  Status = LegacyBootManagerLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
